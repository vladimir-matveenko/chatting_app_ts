...
export class GetUserByIdRequestValidator implements RequestValidator<GetUserByIdRequestDto> {
  validate(request: Request): GetUserByIdRequestDto {
    return {
      id: requireId(request.params.id, "id"),
    };
  }
}
